...
export default function BlogSection() {
  ...
  return (
    <section className="relative py-28 px-6 md:px-16 bg-[#0b0f19] text-white overflow-hidden">

      {/* Background Glow */}
      <div className="absolute top-[-150px] left-[-150px] w-[450px] h-[450px] bg-[#e0bc80] opacity-10 rounded-full" />
      <div className="absolute bottom-[-150px] right-[-150px] w-[500px] h-[500px] bg-[#b2895d] opacity-10 rounded-full" />
